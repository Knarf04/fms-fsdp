...
def get_model_config(model_variant):
    ...
    elif model_variant == "llama_1b_aux20":
        model_config = LLaMAConfig(
            src_vocab_size=128256,
            emb_dim=1280,
            nheads=16,
    ...
    elif model_variant == "llama_1b_yarn":
        model_config = LLaMAConfig(
            src_vocab_size=128256,
            emb_dim=1280,
            nheads=16,
    ...
    elif model_variant == "llama_1b_yarn_old":
        model_config = LLaMAConfig(
            src_vocab_size=128256,
            emb_dim=1280,
            nheads=16,
    ...
    elif model_variant == "llama_1b_fixed":
        model_config = LLaMAConfig(
            src_vocab_size=128256,
            emb_dim=1280,
            nheads=16,
    ...
    elif model_variant == "mamba_1b_long":
        model_config = {
            "d_model": 1280,
            "d_intermediate": 3072,
            "n_layer": 32,
